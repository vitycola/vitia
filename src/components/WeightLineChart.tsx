import { windowSpanDays } from "@/lib/weightDashboard";
import type { LinePoint, RenderState } from "@/lib/weightDashboard";
 ...
 * MeasurementsLineChart's no-library approach, but draws a line (not bars)
 * connecting only real logged weight points, with no goal line. Three
 ...
 * construction.
 */
export function WeightLineChart({ points, renderState, window }: WeightLineChartProps) {
