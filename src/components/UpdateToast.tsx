  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="rounded-lg bg-accent px-3 py-1 font-medium text-accent-foreground hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
      >
        Actualizar
      </button>
      <button
